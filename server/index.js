...
const google_sheet_apikey = process.env.PRIVATE_KEY_ID;
app.get('/valores/tabla_usd_largo_plazo_local', async (req, res) => {
  console.log('Endpoint llamado');
  try {
    const url = 'https://sheets.googleapis.com/v4/spreadsheets/'+ spreadsheetId +'/values/'+ range + '?key=' +google_sheet_apikey;
